...
const Signup = () => {
  ...
  return (
    <div className='flex items-center justify-center w-full h-screen'>
        ...
        <h1 className='text-center font-medium my-2 text-2xl'>Signup</h1>
            ...
            <button type='submit' className='bg-[#1B61D1] text-white rounded-md p-2 mb-4' >
                SignUp
            </button>
            <p>Already have an an account? <Link to={"/login"} className='text-blue-600 m-1'>Login</Link></p>
        </form>
